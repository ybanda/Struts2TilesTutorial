...
var imgsrc = new Array("js/drop1.gif", "js/drop2.gif", "js/left1.gif", "js/left2.gif", "js/right1.gif", "js/right2.gif")
...
function constructDate(d, m, y)
{
   ...
   sTmp = sTmp.replace("yy", y - 2000)
   return sTmp.replace("y", y - 2000)
}
      ...
      if (crossobj.visibility == "hidden") {
         ...
         if (formatChar != "") {
            ...
            for (i = 0; i < 3; i++) {
               ...
               else if ((aFormat[i] == "y") || (aFormat[i] == "yy")) {
